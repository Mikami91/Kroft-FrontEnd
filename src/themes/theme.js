...
import { amber, blue, cyan, deepOrange, deepPurple, green, indigo, lightBlue, lightGreen, lime, orange, pink, purple, red, teal, yellow } from '@material-ui/core/colors';
...
export const primaryBoxShadow = {
  boxShadow:
  "0 12px 20px -10px " + fade(theme.palette.primary[900], 0.5)+ ", 0 4px 20px 0px " + fade(theme.palette.primary[100], 0.1) + ", 0 7px 8px -5px " + fade(theme.palette.primary[500], 0.2)
};
export const secondaryBoxShadow = {
  boxShadow:
  "0 12px 20px -10px " + fade(theme.palette.secondary[900], 0.5)+ ", 0 4px 20px 0px " + fade(theme.palette.secondary[100], 0.1) + ", 0 7px 8px -5px " + fade(theme.palette.secondary[500], 0.2)
};
...
export const primaryCardHeader = {
  color: "#fff",
  background: "linear-gradient(60deg," + theme.palette.primary[400] + "," + theme.palette.primary[500] + ")",
  ...primaryBoxShadow
};
export const secondaryCardHeader = {
  color: "#fff",
  background: "linear-gradient(60deg," + theme.palette.secondary[400] + "," + theme.palette.secondary[500] + ")",
  ...secondaryBoxShadow
};
