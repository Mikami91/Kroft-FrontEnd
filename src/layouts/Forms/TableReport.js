...
// Functions
import { collectTableReport } from "../../functions/cruds/collectFunctions";
// Configs
moment.locale("es");
moment().format('l');
...
function TableReport(props) {
    ...
    const handleReport = (e) => {
        e.preventDefault();
        collectTableReport(state).then((response) => {
    ...
    return (
        <form id="table-report" onSubmit={handleReport}>
            ...
            <Card variant="cardForm">
                ...
                <CardBody form>
                    ...
                    >
                        ...
                        >
                            ...
                            <CustomDivider text="Mesa" color="warning" margin="normal" bold />
                ...
                <CardFooter form>
                    <CustomBotton form="table-report" size="sm" type="submit" disabled={state.isUpload} >
                        Generar
                    </CustomBotton>
                </CardFooter>
            </Card>
...
export default connect(mapStateToProps, null)(TableReport);
