...
// Layouts
import CashierReport from "../Forms/CashierReport";

function CashierReports({ data, fetching, loading }) {
  return (
    <Fragment>
      <Grid
        container
...
const mapStateToProps = (state) => {
  ...
  return {
    data: collects.cashier,
    fetching: collects.fetching,
    loading: collects.loading,
  }
};

export default connect(mapStateToProps, null)(CashierReports);