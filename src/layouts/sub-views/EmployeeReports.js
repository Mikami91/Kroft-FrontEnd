...
// Layouts
import EmployeeReport from "../Forms/EmployeeReport";

function EmployeeReports({ data, fetching, loading }) {
  return (
    <Fragment>
      <Grid
        container
            ...
            <CardBody form>
              <CustomTable
                column={[
                  ...
                  { title: "Personal", field: "cashier_first_name", type: "string" },
...
const mapStateToProps = (state) => {
  ...
  return {
    data: collects.employee,
    fetching: collects.fetching,
    loading: collects.loading,
  }
};

export default connect(mapStateToProps, null)(EmployeeReports);