        ...
        <Table aria-label="collapsible table">
          ...
          <TableBody>
            {orders_filtered.map((index, key) => [
                  ...
                  if (index[key_field] === filter) {
                    if (col.type === "text") {
                      return (
                        ...
                        >
                          {col.time === true ? (
                            moment(index[col.field]).fromNow()
                          ) : (
                            <CustomText
                    ...
                    if (col.type === "expand") {
                      return (
                        ...
                        >
                          {state.isExpanded &&
                          index.order_number === state.index ? (
                            ...
                            <IconButton
                              onClick={() => handleOpenExpanded(index)}
                            >
              ...
              state.isExpanded && state.index === index.order_number ? (
                <ExpandedRow key={index.order_number} />
              ) : null,
            ])}
          </TableBody>
        </Table>
