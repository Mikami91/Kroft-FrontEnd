        ...
        {Object.entries(result).map((index) => (
          <Fragment key={index[0] + "f"}>
            <TableHead key={index[0] + "h"}>
              <TableRow>
                <TableCell
                  className={classes.tTableName}
                  align="left"
                  colSpan={1}
                >
                  {`${current.table_name} ${current.table_number}`.toUpperCase()}
                </TableCell>
                <TableCell className={classes.tDate} align="right" colSpan={1}>
                  {currentDate}
                </TableCell>
              </TableRow>
                ...
                <Fragment key={i.product_id + "f2"}>
                  ...
                  {i.observation === "" ? null : (
                    <TableRow>
                      ...
                      <TableCell
                        className={classes.tObservation}
                        align="left"
                        colSpan={1}
                      >
                        {i.product_observation}
                      </TableCell>
                    </TableRow>
                  )}
                </Fragment>
